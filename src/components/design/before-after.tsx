  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ left: `${pos}%` }}
      >
        <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 h-12 w-12 rounded-full bg-card border-2 border-primary shadow-[0_4px_14px_rgba(42,39,36,0.25)] flex items-center justify-center">
